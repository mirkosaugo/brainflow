- [user_profile.md](user_profile.md) — Mirko is a web architect AI with creative frontend background, builds BrainFlow as case history for solo AI orchestration
- [project_orchestration_setup.md](project_orchestration_setup.md) — BrainFlow: brainstorming canvas with Digital Twins, 6 skills, full orchestration infra (2026-03-24)
